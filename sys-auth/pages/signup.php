<div class="body">
    ...
    <form method="post" action="/api/signup.php" onsubmit="return handleSubmit();">
        ...
        <div class="form-group" style="margin-bottom: 10px;">
            ...
            <input type="radio" name="i_domain_type" class="with-gap radio-col-<?= config('branding.accent_color'); ?>" id="i_domain_type_own">
            <label for="i_domain_type_own"><?= __('I have my own domain') ?></label>
            <br>
            <input type="radio" name="i_domain_type" class="with-gap radio-col-<?= config('branding.accent_color'); ?>" id="i_domain_type_sub">
        ...
        <div id="section_custom_domain" class="hidden">
            ...
            <div class="form-group form-float">
                <div class="form-line">
                    <input type="text" id="input_domain" name="domain" class="form-control">
